...
import com.rpg.combates.Onda_Devastadora;
...
public class Dobrador_de_Agua extends Heroi {
    ...
    public Dobrador_de_Agua(String nome, int pontosDeVida, int forca, int nivel, int experiencia, int calma,  Arma arma, int expProximoNivel, float sorte) {
        super(nome, pontosDeVida, forca, nivel, experiencia, arma, expProximoNivel, sorte);
        this.calma = calma;
        acoes.add(new Onda_Devastadora());
