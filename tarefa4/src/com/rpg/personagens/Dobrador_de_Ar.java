...
public class Dobrador_de_Ar extends Heroi {
    ...
    public Dobrador_de_Ar(String nome, int pontosDeVida, int forca, int nivel, int experiencia, int liberdade, Arma arma, int expProximoNivel, float sorte) {
        super(nome, pontosDeVida, forca, nivel, experiencia, arma, expProximoNivel, sorte);
        this.liberdade = liberdade;
        acoes.add(new Furacao());
